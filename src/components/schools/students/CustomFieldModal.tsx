...
export default function CustomFieldModal({
  ...
  return (
    <ModalPortal isOpen={isOpen}>
      <div
        className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs animate-fadeIn"
        onClick={onClose}
      >
        <div
          className="bg-white border border-slate-200 rounded-2xl w-full max-w-2xl max-h-[85vh] sm:max-h-[88vh] flex flex-col shadow-2xl overflow-hidden my-auto relative"
