...
export default function ShowcaseMode() {
  ...
  return (
    ...
    >
      {/* ── Interactive HUD Controls (Top Bar & Side Chevrons) ──────── */}
      <ShowcaseControls />

      {/* ── Initial HUD Keyboard Hint (Auto Fades) ────────────────── */}
      <div
        className={`absolute top-20 left-1/2 -translate-x-1/2 z-[100000] px-4 py-2 bg-black/75 backdrop-blur-md border border-white/20 rounded-full text-[11px] font-medium text-white/90 shadow-2xl transition-all duration-700 pointer-events-none ${
