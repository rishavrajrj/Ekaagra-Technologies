...
export const planDomainAllowances: Record<string, number> = {
  ...
  'business-website-cms': 500,
  'website-design-dev': 500,
  'web-applications': 500,
  'android-applications': 500,
  'custom-software': 500,
  'business-solutions': 500,
  'free-launch': 0,
  'launch-plus': 300,
  'starter': 500,
...
export const websitePlans: WebsitePlan[] = [
  ...
  },
  {
    ...
    tagline: 'Professional responsive website for small businesses, consultants, brands and local organizations.',
    description: 'Professional responsive website for small businesses, consultants, brands and local organizations.',
    domainIncluded: true,
    domainAllowance: planDomainAllowances['business-website'],
    domainDetails: '1 Standard Custom Domain Included (Within ₹500/yr allowance)',
    seoIncluded: true,
    maintenanceIncluded: true,
    maintenanceNote: 'Basic maintenance ensuring website remains properly deployed and operational.',
    features: [
      'Up to 8–10 pages',
    ...
    ctaText: 'GET STARTED →',
    ctaHref: '/get-quote?plan=business-website',
  },
  {
    ...
    pages: 'Up to 10',
    badge: 'Self-Managed',
    tagline: 'Professional website with a simple CMS for managing business content without technical help.',
    description: 'Professional website with a simple CMS for managing business content without technical help.',
    domainIncluded: true,
    domainAllowance: planDomainAllowances['business-website-cms'],
    domainDetails: '1 Standard Custom Domain Included (Within ₹500/yr allowance)',
    seoIncluded: true,
    maintenanceIncluded: true,
    maintenanceNote: 'CMS platform & hosting maintenance included.',
    features: [
      'Up to 10 pages',
    ...
    ctaText: 'GET STARTED →',
    ctaHref: '/get-quote?plan=business-website-cms',
  },
  {
    ...
    highlighted: true,
    tagline: 'Bespoke corporate websites designed around your brand, content and business goals.',
    description: 'Bespoke corporate websites designed around your brand, content and business goals.',
    domainIncluded: true,
    domainAllowance: planDomainAllowances['website-design-dev'],
    domainDetails: '1 Standard Custom Domain Included (Within ₹500/yr allowance)',
    seoIncluded: true,
    maintenanceIncluded: true,
    maintenanceNote: 'Maintenance and stability patches included.',
    features: [
    ...
    ctaText: 'GET STARTED →',
    ctaHref: '/get-quote?plan=website-design-dev',
  },
  {
    id: 'web-applications',
    ...
    tagline: 'Interactive web applications with dashboards, authentication, workflows and database functionality.',
    description: 'Interactive web applications with dashboards, authentication, workflows and database functionality.',
    domainIncluded: true,
    domainAllowance: planDomainAllowances['web-applications'],
    domainDetails: '1 Custom Domain Included (Within ₹500/yr allowance)',
    seoIncluded: true,
    maintenanceIncluded: true,
    maintenanceNote: 'Database & application maintenance included.',
    features: [
    ...
    ctaText: 'GET STARTED →',
    ctaHref: '/get-quote?plan=web-applications',
  },
  {
    ...
    tagline: 'Mobile applications for businesses and organizations, built around your required workflows.',
    description: 'Mobile applications for businesses and organizations, built around your required workflows.',
    domainIncluded: true,
    domainAllowance: planDomainAllowances['android-applications'],
    domainDetails: 'API & server domain included',
    seoIncluded: true,
    maintenanceIncluded: true,
    maintenanceNote: 'API backend & mobile maintenance included.',
    features: [
      'Android application',
    ...
    ctaText: 'GET STARTED →',
    ctaHref: '/get-quote?plan=android-applications',
  },
  {
    id: 'custom-software',
    ...
    priceDisplay: '₹34,999',
    duration: 'Year 1',
    pages: 'Modular System',
    badge: 'Bespoke Engineering',
    tagline: 'Bespoke software engineered around specific business processes and operational workflows.',
    description: 'Bespoke software engineered around specific business processes and operational workflows.',
    domainIncluded: true,
    domainAllowance: planDomainAllowances['custom-software'],
    domainDetails: 'Enterprise domain setup included',
    seoIncluded: true,
    maintenanceIncluded: true,
    maintenanceNote: 'Enterprise operational stability & bug fixes included.',
    features: [
      'Custom workflows',
    ...
    ctaText: 'GET STARTED →',
    ctaHref: '/get-quote?plan=custom-software',
  },
  {
    ...
    tagline: 'Tailored digital systems for businesses requiring specialized workflows, integrations or multi-user operations.',
    description: 'Tailored digital systems for businesses requiring specialized workflows, integrations or multi-user operations.',
    domainIncluded: true,
    domainAllowance: planDomainAllowances['business-solutions'],
    domainDetails: 'Custom enterprise infrastructure',
    seoIncluded: true,
    maintenanceIncluded: true,
    maintenanceNote: 'SLA-backed maintenance agreement.',
    features: [
    ...
    ctaHref: '/get-quote?plan=business-solutions',
  },
];
...
export const pricingTiers: PricingTier[] = [
  {
    title: 'Website Design & Development',
    startingFrom: '₹15,000 (Year 1)',
    description: 'Bespoke corporate websites designed around your brand, content and business goals.',
    badge: 'Custom Corporate',
    scopeAlignment: 'Ideal for custom corporate websites with bespoke branding, fast load speeds, and clean structure.',
    features: [
      'Custom UI/UX & Brand Layout',
      '1 Standard Domain & Edge Hosting Support',
      '✓ Maintenance Included (Deployments & Operational Fixes)',
      '✓ SEO-Ready Structure & Schema Markup',
      'Advanced Forms & WhatsApp Integration',
  ...
  },
  {
    ...
    features: [
      ...
      'Dynamic Content & Real-Time Records',
  ...
  },
  {
    ...
    description: 'Mobile applications for businesses and organizations, built around your required workflows.',
    badge: 'Mobile Package',
    scopeAlignment: 'Dedicated Android applications or hybrid WebView architectures built for your business operations.',
    features: [
      ...
      'Secure Client Login & Local Storage',
    ],
    cta: 'Get a Quote',
  },
  {
    title: 'Custom Software',
    startingFrom: '₹34,999 (Year 1)',
    description: 'Bespoke software engineered around specific business processes and operational workflows.',
